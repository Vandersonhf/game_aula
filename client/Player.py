...
class Player(Sprite):
    ...
    def check_collision (self, asteroids, mobs, pows, shields, boss, socket = None):        
        ...
        for rock in asteroids:
            ...
            if rock.dead and rock.idx_ani >= len(rock.list_surf)-1 and rock.delay > rock.delay_ani-1:                   
                ...
                if r == 1 and self.life < 3:
                    shield = ShieldUP(1, rock.col_rect.center, (50,50))                               
                    shields.add(shield) 
        ...
        for mob in mobs:
            ...
            if mob.dead and mob.idx_ani >= len(mob.list_surf)-1 and mob.delay > mob.delay_ani-1:                   
                ...
                if r == 1 and self.ups < 5:
                    pow = PowerUP(1, mob.col_rect.center, (50,50))                               
                    pows.add(pow)                    
            ...
            if not pow.dead:
                ...
                if jogadorColidiu:
                    if self.ups < 5:
                        ...
                        pow.get()
                        self.update_power()
                        if socket and settings.multiplayer:
                            message = 'up_'+str(self.ups)+'_'
