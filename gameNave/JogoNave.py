...
class JogoNave():
    ...
    def main_loop(self):
        ...
        while self.running:
            ...
            self.display.draw_background(self.score, self.high_score)
            ...
            #atualiza jogador   
            self.running = self.player.update(self.rocks)
    ...
    def set_enemies(self, rocks, counter:int):    
        ...
        if counter >= self.ITERACOES:
            ...
            rock = Enemy(self.surfaces.surf_asteroid, posX, posY, size, vel)        #create enemy        
            rocks.add(rock)
        return counter
